...
O código-fonte completo do projeto está disponível em https://github.com/Hosamuel/classifique-render.git e pode ser executado localmente para fins de reprodução e testes.
