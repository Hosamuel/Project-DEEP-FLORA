...
O código-fonte completo do projeto está disponível em P[lants-Image-Classification](https://github.com/Hosamuel/classifique-render.git) e pode ser executado localmente para fins de reprodução e testes.
